...
import br.com.giannatech.gestaovagas.modules.company.usecases.CreateJobUseCase;
...
class CreateJobUseCaseTest {
    ...
    @Test
    void should_be_able_to_create_a_job() {
    ...
    @Test
    void shoub_not_be_able_to_create_a_job_if_the_company_doesnt_exists() {
